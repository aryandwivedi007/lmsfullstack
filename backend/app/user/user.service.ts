...
export const getUserById = async (id: string) => {
    return await UserRepository.findOne({
        where: { _id: id },
        select: ["_id", "name", "email", "role", "active", "createdAt", "updatedAt"], // Exclude refreshToken
        relations: {
            enrolledCourses: true, // Fetch enrolled courses
            createdCourses: true,  // Fetch courses created by this user (if instructor)
        }
